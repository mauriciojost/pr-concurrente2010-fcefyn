...
/* Clase Guanaco. <Es> Animal y <puede> Correr. */
public class Guanaco extends Animal implements Corredor{
	protected Pista pista; /* Como Corredor necesita conocer la Pista para actualizar su posición al correr. */
	protected int position=0; /* Posición actual del Guanaco. */
	
	Guanaco(String nombre) {
	...
	public void run() {
		try{
			...
			System.out.println("Soy " + this.getID() +". LLegó el Guanaco!!");
		}
	}
